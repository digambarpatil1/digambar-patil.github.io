...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "10.1.0"
  WORKING_DIRECTORY "/home/ubuntu/dev-experiments/Cmake/MyProject/build/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ubuntu/dev-experiments/Cmake/MyProject/build/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ubuntu/dev-experiments/Cmake/MyProject/build/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
